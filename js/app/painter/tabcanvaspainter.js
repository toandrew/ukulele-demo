define(['app/utils'], function(Utils){
	...
	var CanvasPainter = function(parentDiv, tabBlock) {

		this.debug = false;

		this.canvas = document.createElement('canvas');
		this.canvas.setAttribute('width', UkuConstants.staveWidth);
	...
	CanvasPainter.prototype = {
		resize: function() {
			...
			for (var i = 0; i < UkuConstants.topColumnModifiers.length; i++) {
				if (Utils.objectSize(this.tabBlock.data['colmodifiers'][UkuConstants.topColumnModifiers[i]]) > 0) {
			...
			for (var i = 0; i < UkuConstants.bottomColumnModifiers.length; i++) {
				if (Utils.objectSize(this.tabBlock.data['colmodifiers'][UkuConstants.bottomColumnModifiers[i]]) > 0) {
			...
			this.stepX = (this.canvasW - this.noteMargin * 2)/UkuConstants.tabBlockLength;
		...
		paintColumnModifiers: function() {
			...
			var stepX = this.canvasW/UkuConstants.getTabBlockLength();
